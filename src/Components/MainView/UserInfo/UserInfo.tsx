    ...
    return (
        <div className={c.userInfo}>
            ...
            <div className={c.userInfo_scores}>
                <Counter title="Repos count" icon={() => {return <RepositoryIcon></RepositoryIcon>}} count={props.userInfo.public_repos}/>
                <Counter title="followers" icon={() => {return <StarIcon></StarIcon>}} count={props.userInfo.followers}/>
                <Counter title="following" icon={() => {return <AccountIcon></AccountIcon>}} count={props.userInfo.following}/>
            </div>
        </div>
    )
}
